...
BOOST_AUTO_TEST_CASE( ExtractSubcktName )
{
    ...
    BOOST_CHECK_EQUAL( SPICE_MODEL_DOWNLOADER::ExtractSubcktName( text1 ),
                       wxString( "BLM18PG121SN1" ) );
    ...
    wxString text4 = wxS( "* Murata ferrite bead model\n.SUBCKT BLM15PX121SN1 port1 port2\n"
                          "R1 port1 1 0.05\n.ENDS\n" );
    BOOST_CHECK_EQUAL( SPICE_MODEL_DOWNLOADER::ExtractSubcktName( text4 ),
                       wxString( "BLM15PX121SN1" ) );
}
