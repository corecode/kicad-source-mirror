...
public:
     ...
     */
    wxString BuildSpiceNetlist( const PDN_NETWORK& aNetwork, const SCH_SHEET_PATH& aObservationSheet,
                                double aTraceInductance = 10e-9, double aTraceResistance = 5e-3,
                                double aStartFreq = 1e3, double aEndFreq = 1e9, int aPointsPerDecade = 100 );
     ...
     */
    wxString BuildSpiceNetlist( const wxString& aNetworkKey, const SCH_SHEET_PATH& aObservationSheet,
                                double aTraceInductance = 10e-9, double aTraceResistance = 5e-3,
                                double aStartFreq = 1e3, double aEndFreq = 1e9, int aPointsPerDecade = 100 );
     ...
     */
    bool RunAnalysis( const PDN_NETWORK& aNetwork, const SCH_SHEET_PATH& aObservationSheet,
                      double aTraceInductance = 10e-9, double aTraceResistance = 5e-3 );
     ...
     */
    static std::optional<PARASITIC_ENTRY> GetParasitics( const wxString& aCaseSize, double aCapacitance );
