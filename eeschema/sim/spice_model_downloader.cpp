...
const SPICE_MODEL_DOWNLOADER::MODEL_SOURCE* SPICE_MODEL_DOWNLOADER::findSource( const wxString& aMpn ) const
{
...
{
    SPICE_MODEL_RESULT result = { false, wxEmptyString, wxEmptyString, wxEmptyString, wxEmptyString };
